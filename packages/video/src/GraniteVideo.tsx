...
function normalizeDrm(
  drm?: GraniteVideoProps['drm']
): NativeProps['drm'] | undefined {
...
function normalizeBufferConfig(
  config?: GraniteVideoProps['bufferConfig']
): NativeProps['bufferConfig'] | undefined {
...
export const GraniteVideo = forwardRef<VideoRef, GraniteVideoProps>(
  (props, ref) => {
    const {
      // Test ID
      testID,
