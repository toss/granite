...
export function getPreludeConfig(options: MicroFrontendPluginOptions, appName?: string): MicroFrontendPreludeConfig {
  ...
  return {
    ...
    preludeScript: [
      ...
      '}',
      `const __appName = ${containerName};`,
      `const __containerConfig = ${containerConfig};`,
      'const __appConfig = global.__granite == null ? null : global.__granite.app;',
      'if (__appConfig != null && __appConfig.name === __appName && typeof __appConfig.scheme === "string") {',
      '  __containerConfig.scheme = __appConfig.scheme;',
      '  if (typeof __appConfig.host === "string") { __containerConfig.host = __appConfig.host; }',
      '}',
      'const __container = createContainer(__appName, __containerConfig);',
      ...registerStatements,
      ...exposeStatements,
    ].join('\n'),
  };
