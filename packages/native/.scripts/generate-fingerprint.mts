...
const moduleString = MODULE_TEMPLATE.replace('$FINGERPRINT', crypto.createHash('md5').update(depsString).digest('hex'));

console.log(`👉 Generated fingerprint: ${fingerprint}`);

await fs.writeFile(path.join(ROOT, 'src/fingerprint.ts'), moduleString, 'utf-8');
