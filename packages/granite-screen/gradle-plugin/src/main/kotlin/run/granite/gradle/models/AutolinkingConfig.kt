...
data class AutolinkingConfig(
     ...
     */
    fun androidDependencies(): List<NativeModule> {
        return dependencies.mapNotNull { (name, config) ->
     ...
     */
    fun javaModules(): List<NativeModule> {
        return androidDependencies().filter { it.hasJavaImplementation }
    }
     ...
     */
    fun cxxModules(): List<NativeModule> {
        return androidDependencies().filter { it.hasCxxImplementation }
    }
     ...
     */
    fun fabricModules(): List<NativeModule> {
        return androidDependencies().filter { it.hasFabricComponents }
    }
     ...
     */
    fun cmakeModules(): List<NativeModule> {
        return androidDependencies().filter { it.hasCMakeConfiguration }
    }
}
