...
class RepositoryConfigurator(
    ...
    /**
     * Checks if a repository with the given name already exists.
     */
    private fun hasRepository(name: String): Boolean {
        return project.repositories.findByName(name) != null
    }
}
