module.exports = {
  ...
  get SceneTracker() {
    return require("react-native/Libraries/Core/Devtools/SceneTracker");
  },
  get getInspectorDataForViewAtPoint() {
    return require("react-native/Libraries/Core/Devtools/getInspectorDataForViewAtPoint");
  },
  get LoadingView() {
    return require("react-native/Libraries/Core/Devtools/LoadingView");
  },
  get XHRInterceptor() {
